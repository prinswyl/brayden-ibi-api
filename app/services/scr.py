    ...
    async def list_register(
        ...
        items = [
            WorkerSCRRegisterRow(
                ...
                staff_category=wp.staff_category,
                employment_start_date=wp.employment_start_date,
                scr_status=scr.scr_status if scr else None,
                id_verification_method=scr.id_verification_method if scr else None,
                initial_id_checked_date=scr.initial_id_checked_date if scr else None,
                initial_id_notes=scr.initial_id_notes if scr else None,
                ...
                dbs_risk_assessment_date=scr.dbs_risk_assessment_date if scr else None,
                dbs_risk_assessment_not_applicable=scr.dbs_risk_assessment_not_applicable if scr else False,
                dbs_barred_list_included=scr.dbs_barred_list_included if scr else False,
                ...
                dbs_last_update_check_date=scr.dbs_last_update_check_date if scr else None,
                dbs_last_update_result=scr.dbs_last_update_result if scr else None,
                external_dbs_portal_reference=scr.external_dbs_portal_reference if scr else None,
                barred_list_checked_date=scr.barred_list_checked_date if scr else None,
                barred_list_not_applicable=scr.barred_list_not_applicable if scr else False,
                tra_prohibition_checked_date=scr.tra_prohibition_checked_date if scr else None,
                tra_not_applicable=scr.tra_not_applicable if scr else False,
                qualifications_checked_date=scr.qualifications_checked_date if scr else None,
                section_128_checked_date=scr.section_128_checked_date if scr else None,
                section_128_not_applicable=scr.section_128_not_applicable if scr else False,
                ...
                overseas_checks_details=scr.overseas_checks_details if scr else None,
                overseas_check_evidence=scr.overseas_check_evidence if scr else None,
                overseas_checks_verified_date=scr.overseas_checks_verified_date if scr else None,
            )
